            ...
            <CardContent>
                <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                    <div className="space-y-3">
                        ...
                        >
                            <SelectTrigger id="industry" className="w-[400px]">
                    ...
                    {watchIndustry && (
                        ...
                        <Select
                            ...
                            <SelectTrigger id="subIndustry" className="w-[400px]">
                    ...
                    <div className="space-y-3">
                        ...
                        <Input
                            ...
                            min="0"
                            max="50"
                            placeholder="Enter years of experience"{...register("experience")}
                        />
                        {errors.experience && (
                    ...
                    <div className="space-y-3">
                        ...
                        <Input
                            id="skills"
                            placeholder="e.g., Python, Javascript, Project Management"{...register("skills")}
                            />
                    ...
                    <Button type="submit" className="w-full" disabled={updateLoading}>{updateLoading ? (
                        <>
